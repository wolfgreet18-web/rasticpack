                ...
                CompositionLocalProvider(LocalLayoutDirection provides LayoutDirection.Rtl) {
                    ...
                    Box(
                        ...
                        ResponsiveContentWidth {
                            when (screen) {
                                "engineTest" -> EngineTestScreen(onBack = { screen = "home" })
                                "databaseTest" -> DatabaseTestScreen(onBack = { screen = "home" })
                                "calc2" -> Calc2Screen(onBack = { screen = "home" })
                                "inventory" -> InventoryScreen(onBack = { screen = "home" })
                                "customers" -> CustomersScreen(onBack = { screen = "home" })
                                ...
                                "settings" -> SettingsScreen(onBack = {
                                    ...
                                    onOpenEngineTest = { screen = "engineTest" },
                                    onOpenDatabaseTest = { screen = "databaseTest" },
                                    onOpenCalc2 = { screen = "calc2" },
                                    onOpenInventory = { screen = "inventory" },
                                    onOpenCustomers = { screen = "customers" },
                                    onOpenInvoices = { screen = "invoices" },
                                    onOpenProduction = { productionApplyId = null; screen = "production" },
